...
export default function EmployeeOrderDetails({ params }: { params: Promise<{ id: string }> }) {
  ...
  const isReceiptVerified =
    order && order.receipt_url && ["confirmed", "processing", "ready-to-pickup", "completed"].includes(order.status)
        ...
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/employee/orders">Orders</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
