...
import { Search, Receipt, CheckCircle, X, Check, Calendar, CalendarDays, Clock3, Home, MapPin, AlertTriangle, Shield, FileText, XCircle, CheckCheck, ImageIcon, Ruler, Bed, Utensils, Activity, Info, Eye, Edit, Trash2 } from 'lucide-react'
...
interface Appointment {
  ...
  client_email: string
  client_phone: string
  pet_names: string  // Changed from pet_name to pet_names (comma-separated)
  pet_species: string  // Changed from pet_species to multiple species (comma-separated)
  pet_breeds: string  // Changed from pet_breed to pet_breeds (comma-separated)
  service_name: string
...
export default function EmployeeAppointments() {
  ...
  // Add new state for appointment details dialog
  ...
  const updateAppointmentStatus = async (appointmentId: number, newStatus: string) => {
    ...
    if (
      ...
      toast({
        title: "Error",
        description: "Payment must be verified before changing status to in progress or completed",
        variant: "destructive",
      })
      return
    }
      ...
      if (response.ok) {
        ...
        if (selectedReceipt) {
          setSelectedReceipt({
            ...
            receipt_verified_by: null, // Assuming this will be set by the backend or is not needed here
  ...
  // Add function to fetch appointment details
  ...
  const formatAmount = (amount: string | null, servicePrice: string) => {
    if (amount && amount !== null) {
      return `Php ${Number.parseFloat(amount).toLocaleString()}`
    } else if (servicePrice && servicePrice !== null) {
      return `Php ${Number.parseFloat(servicePrice).toLocaleString()}`
    }
    return "Php 0.00"
  }
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/employee/appointments">Appointments</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                                ...
                                <div className="space-y-1">
                                  ...
                                  {appointment.cage_rate && (
                                    <div className="text-xs font-medium text-green-600">
                                      Php {Number(appointment.cage_rate).toFixed(2)}/day
                                    </div>
                                  )}
          ...
          {selectedReceipt && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Pet(s)</p>
      ...
      <Dialog open={isDocumentsDialogOpen} onOpenChange={setIsDocumentsDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Review and verify the ID and signature documents for {selectedDocuments?.pet_names}'s boarding reservation
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Pet Name(s)</p>
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Boarding Details - {selectedBoardingDetails?.pet_names}
            </DialogTitle>
                          ...
                          <>
                            ...
                            <div className="space-y-1">
                              <div className="text-2xl font-bold text-green-600">
                                Php{" "}
                                {selectedBoardingDetails.cage_rate && duration
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-lg font-semibold text-green-600">
                      Php {Number(selectedBoardingDetails.cage_rate || 0).toFixed(2)} per day
                    </div>
                  </div>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Appointment Details - {selectedAppointmentDetails?.pet_names}
            </DialogTitle>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Breed(s)</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-green-600">
                          Php {Number(selectedAppointmentDetails.cage_rate || 0).toFixed(2)}
                        </p>
                      </div>
                    </div>
